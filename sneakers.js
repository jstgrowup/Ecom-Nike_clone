...
for (var i = 0; i < maindata.length; i++) {
  if (maindata[i].category === "sneakers") {
    sneakers.push(maindata[i]);
  }
}
...
var jutaarr = JSON.parse(localStorage.getItem("cartitems")) || [];
function jutafun(el) {
  jutaarr.push(el);
  localStorage.setItem("cartitems", JSON.stringify(jutaarr));
